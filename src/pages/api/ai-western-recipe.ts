...
2. 必要な材料リスト: 分量を具体的に明記し、代替可能な材料の提案も含めてください（例: 乳製品アレルギーの場合の代替案）。
3. 詳細な調理手順: 初心者が安心して取り組める説明を心がけ、注意点や成功させるためのヒントを含めてください。
4. 完成までの時間
5. 調理のポイント: 火加減や切り方、盛り付けのコツなど、美味しく仕上げるための具体的な工夫を記載してください。
6. 地域ごとの洋食アレンジ: フランス風、イタリア風、アメリカ風など、手軽に再現できる地域の風味のコツを提案してください。
7. 他の料理との組み合わせ提案: メイン料理を引き立てるセットメニューとして、味のバランス、地域の一貫性、季節感、調理の簡便さを考慮したサイドメニュー、スープ、デザートを具体的に提案してください。
